...
import model.DocGia;
import Repositories.DocGiaDAO;
import model.NhaXuatBan;
import Repositories.NhaXuatBanDAO;
import model.NhanVien;
import Repositories.NhanVienDAO;

import model.Sach;
import Repositories.SachDAO;
import model.TheLoai;
import Repositories.TheLoaiDAO;

public class giaoDIen extends javax.swing.JFrame {

    Object[][] nv_data;
    Object[] nv_columns = {"Ma nhan vien", "Ten nhan vien", "Ten dang nhap", "Mat Khau", "SDT",
        "Dia chi", "CMND", "Gioi tinh", "Cap bac"};
    ...
    public void showTableNhanVien() {
        ...
        for (int i = 0; i < listNhanVien.size(); i++) {
            ...
            Object[] tmpRow = new Object[]{
                ...
                listNhanVien.get(i).getSdt(), listNhanVien.get(i).getDiachi(), listNhanVien.get(i).getCMND(),
...
//        nv_tf_mk.setText("");
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jScrollPane6, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 578, Short.MAX_VALUE)
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGap(71, 71, 71)
                                        .addComponent(nv_tf_cmnd, javax.swing.GroupLayout.PREFERRED_SIZE, 173, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                            .addComponent(jLabel26)
                                            .addGap(65, 65, 65)
                                            .addComponent(nv_tf_diachi, javax.swing.GroupLayout.PREFERRED_SIZE, 173, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jLabel71.setText("Hệ thống quản lý thư viện Nhóm 6 phát triển");
    ...
    private void tbl_nvMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_nvMouseClicked
        if (evt.getID() == MouseEvent.MOUSE_CLICKED) {
            ...
            nv_tf_cmnd.setText(String.valueOf(tbl_nv_model.getValueAt(tbl_nv.getSelectedRow(), 6)));
            if (String.valueOf(tbl_nv_model.getValueAt(tbl_nv.getSelectedRow(), 7)).equalsIgnoreCase("nam")) {
            ...
            nv_capbac.setSelectedItem(String.valueOf(tbl_nv_model.getValueAt(tbl_nv.getSelectedRow(), 8)));
        }
